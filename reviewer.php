      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link" href="homepage.html"><p class="font-weight-bold"> Home </p> <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="reviewer.html"><p class="font-weight-bold"> Reviewer </p> </a>
          </li>
          <li class="nav-item">
