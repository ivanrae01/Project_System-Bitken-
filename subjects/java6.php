...
<html lang="en">
  <head>
    ...
    <title> JAVA: Compiling, Whitespace, Statements </title>
  </head>
  <body>
  ...
  <header>
    ...
    <?php
    echo nl2br (" Compiling Java\n
    -   when compiling a program, each individual class is converted into a .class file, which is known as byte code.\n
    \n
    Whitespace\n
